<div class="form-group">
    {!! Form::label('omschrijving','Omschrijving van de extra-info') !!}
    <div class="input-group">
        ...
        <div class="input-group-btn">
            ...
            <a href="{{route('extrainfo.index')}}" type="button" class="btn btn-default" id="btnList">
...
<script language="javascript" type="text/javascript">
    ...
    function setUp() {
        obj1 = new SelObj('form_name','select_field','omschrijving','extrainfo');
