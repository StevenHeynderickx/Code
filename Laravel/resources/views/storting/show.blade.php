        ...
        <div class="col-md-4 text-right hideMeForPrint">
            <h2>&nbsp;
                <div class="btn-group" role="group" aria-label="...">
                    <a href="/storting/{{$activiteit->id}}/edit" type="button" class="btn btn-primary" id="btnEdit">
                        <span class="glyphicon glyphicon-pencil" aria-hidden="false" aria-label="Aanpassen"></span>
                    </a>
                    <a href="/storting" type="button" class="btn btn-primary" id="btnList">
                    ...
                    <a href="/storting/{{$activiteit->id}}/destroy" type="button" class="btn btn-danger" id="btnDel">
        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-default hideMeForPrint" id="formPanel">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        Voeg een storting van een jongere toe
                    </h3>
                </div>
                <div class="panel-body">
                    <!-- form -->
                    <div class="row">
                        <div class="col-md-12" id="form_jongere">
                            ...
                            {!! Form::open(['route' => 'storting.connect',
                            'name' => 'form_jongere',
                            'id' => 'form_jongere'])
                            !!}
        ...
        <div class="col-md-6">
            @unless(!$activiteit->getJongeren()->get())
                <div class="panel panel-default">
                    <div class="panel-heading hideMeForPrint">
                        <h3 class="panel-title">
                            Volgende jongeren deden een storting
                        </h3>
                    </div>
                    <div class="panel-body">
                        <!-- table -->
                                ...
                                @foreach ($activiteit->getJongeren()->orderBy('eetmee')->orderBy('naam')->get() as $jongere)
                                    <tr>
                                        ...
                                        <td class="hideMeForPrint">
                                            <a href="/storting/{{$jongere->pivot->id}}/disconnect/{{$activiteit->id}}" type="button" class="btn btn-default btn-sm">
